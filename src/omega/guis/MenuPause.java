...
public class MenuPause extends GuiComponent {
	...
	public MenuPause() {
		...
		downUpSound = Sound.loadSoundNow(new MyFile(MyFile.RES_FOLDER, "sounds", "button2.wav"), 1.0f, 1.0f);
		enterSound = Sound.loadSoundNow(new MyFile(MyFile.RES_FOLDER, "sounds", "button1.wav"), 1.0f, 1.0f);
